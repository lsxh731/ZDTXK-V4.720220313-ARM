...
void CInvalidSetdlg::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        CInvalidSetdlg *_t = static_cast<CInvalidSetdlg *>(_o);
        switch (_id) {
        case 0: _t->okBtn_clicked(); break;
        case 1: _t->cancelBtn_clicked(); break;
        case 2: _t->lineEdit_clicked(); break;
        case 3: _t->calendarDay_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData CInvalidSetdlg::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CInvalidSetdlg::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CInvalidSetdlg,
      qt_meta_data_CInvalidSetdlg, &staticMetaObjectExtraData }
};
