...
void CTimePicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData CTimePicker::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CTimePicker::staticMetaObject = {
    { &QwtPlotPicker::staticMetaObject, qt_meta_stringdata_CTimePicker,
      qt_meta_data_CTimePicker, &staticMetaObjectExtraData }
};
